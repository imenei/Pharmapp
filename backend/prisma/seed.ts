...
async function main() {
  ...
  // ── Admin user ─────────────────────────────────────────────────────────
  const adminHash = await bcrypt.hash('Ned@\'0820', 10);
  ...
  // ── Wilayas ────────────────────────────────────────────────────────────
  const wilayas = [
    { code: 1, nom: 'Adrar' }, { code: 2, nom: 'Chlef' },
    { code: 3, nom: 'Laghouat' }, { code: 4, nom: 'Oum El Bouaghi' },
    { code: 5, nom: 'Batna' }, { code: 6, nom: 'Béjaïa' },
    { code: 7, nom: 'Biskra' }, { code: 8, nom: 'Béchar' },
    { code: 9, nom: 'Blida' }, { code: 10, nom: 'Bouira' },
    ...
    { code: 27, nom: 'Mostaganem' }, { code: 28, nom: 'Msila' },
    { code: 29, nom: 'Mascara' }, { code: 30, nom: 'Ouargla' },
    { code: 31, nom: 'Oran' }, { code: 32, nom: 'El Bayadh' },
    { code: 33, nom: 'Illizi' }, { code: 34, nom: 'Bordj Bou Arreridj' },
